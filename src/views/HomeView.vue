<template>
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded" id="heading">
            <a href="#start-shopping" class="bg-white px-2 py-2 rounded ":style="{ color: 'black', 'font-weight': 'bold', 'font-size': '30px' }"> НАЧНЁМ?</a> </h3>
            <p class="lead mb-0 bg-dark p-1 rounded" :style="{ color: 'white', 'font-weight': 'bold', 'font-size': '20px' }">QuickBuy - всегда быстрые покупки</p>
        </header>
      </div>
      <hr />
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <h2 class="pt-3"> Наши категории</h2>
        </div>
      </div>
      <div class="row">
  ...
  <!--    display top products-->
    <div class="container py-2">
      <div class="row">
        <div class="col-12 text-center">
          <h2 class="pt-3"> Наши продукты</h2>
        </div>
      </div>
